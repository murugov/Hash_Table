...
EXMPLE_FILES = example_cmp_for_ht.cpp

all: help

ht: main.cpp $(COMMON_FILES) $(EXMPLE_FILES)
	@echo "-----------------------------------------------------------------------------------------"
	g++ -o ht_program $(FLAGS) main.cpp $(COMMON_INCLUDES) $(CONFIG_INCLUDES) $(STK_INCLUDES) $(HT_INCLUDES) $(COMMON_FILES) $(EXMPLE_FILES)
	@echo "-----------------------------------------------------------------------------------------"
